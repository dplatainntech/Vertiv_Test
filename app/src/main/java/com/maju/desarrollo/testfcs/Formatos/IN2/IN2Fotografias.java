 ...
 */
public class IN2Fotografias extends Fragment {
    String id_formato;
    Bitmap imageBitmap;
    String sLatitud = "0.0";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_in2_fotografias, container, false);
        ...
        try{ if(item.getAntesFoto1().length()>10){foto1_A_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(item.getAntesFoto2().length()>10){foto2_A_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(item.getAntesFoto3().length()>10){foto3_A_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(item.getAntesFoto4().length()>10){foto4_A_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(item.getAntesFoto5().length()>10){foto5_A_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(item.getAntesFoto6().length()>10){foto6_A_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}

        try{ if(item.getDespuesFoto1().length()>10){foto1_D_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(item.getDespuesFoto2().length()>10){foto2_D_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(item.getDespuesFoto3().length()>10){foto3_D_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(item.getDespuesFoto4().length()>10){foto4_D_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(item.getDespuesFoto5().length()>10){foto5_D_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(item.getDespuesFoto6().length()>10){foto6_D_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}


        foto1A_Str= item.getAntesFoto1();
        foto2A_Str= item.getAntesFoto2();
        foto3A_Str= item.getAntesFoto3();
        foto4A_Str= item.getAntesFoto4();
        foto5A_Str= item.getAntesFoto5();
        foto6A_Str= item.getAntesFoto6();
        foto1D_Str= item.getDespuesFoto1();
        foto2D_Str= item.getDespuesFoto2();
        foto3D_Str= item.getDespuesFoto3();
        foto4D_Str= item.getDespuesFoto4();
        foto5D_Str= item.getDespuesFoto5();
        foto6D_Str= item.getDespuesFoto6();
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                item.setAntesFoto1(foto1A_Str);
                item.setAntesFoto2(foto2A_Str);
                item.setAntesFoto3(foto3A_Str);
                item.setAntesFoto4(foto4A_Str);
                item.setAntesFoto5(foto5A_Str);
                item.setAntesFoto6(foto6A_Str);

                item.setDespuesFoto1(foto1D_Str);
                item.setDespuesFoto2(foto2D_Str);
                item.setDespuesFoto3(foto3D_Str);
                item.setDespuesFoto4(foto4D_Str);
                item.setDespuesFoto5(foto5D_Str);
                item.setDespuesFoto6(foto6D_Str);
