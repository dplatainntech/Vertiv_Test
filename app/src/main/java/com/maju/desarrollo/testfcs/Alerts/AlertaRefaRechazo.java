 ...
 */
public class AlertaRefaEntrega extends DialogFragment {

    String mensaje;

    public AlertaRefaEntrega() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_alerta_refa_entrega, container, false);
