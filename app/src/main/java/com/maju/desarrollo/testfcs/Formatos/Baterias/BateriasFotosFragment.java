 ...
 */
public class BateriasFotosFragment extends Fragment {
    String id_formato;
    Bitmap imageBitmap;
    String sLatitud = "0.0";
    ...
    Boolean A1, A2,A3,A4,A5,A6= false,D1= false,D2= false,D3= false,D4= false,D5= false,D6= false;

    public BateriasFotosFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_baterias_fotos, container, false);
        ...
        try{ if(baterias.getFOTOS_A1().length()>10){foto1_A_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(baterias.getFOTOS_A2().length()>10){foto2_A_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(baterias.getFOTOS_A3().length()>10){foto3_A_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(baterias.getFOTOS_A4().length()>10){foto4_A_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(baterias.getFOTOS_A5().length()>10){foto5_A_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(baterias.getFOTOS_A6().length()>10){foto6_A_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}

        try{ if(baterias.getFOTOS_D1().length()>10){foto1_D_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(baterias.getFOTOS_D2().length()>10){foto2_D_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(baterias.getFOTOS_D3().length()>10){foto3_D_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(baterias.getFOTOS_D4().length()>10){foto4_D_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(baterias.getFOTOS_D5().length()>10){foto5_D_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(baterias.getFOTOS_D6().length()>10){foto6_D_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}

        foto1A_Str= baterias.getFOTOS_A1();
        foto2A_Str= baterias.getFOTOS_A2();
        foto3A_Str= baterias.getFOTOS_A3();
        foto4A_Str= baterias.getFOTOS_A4();
        foto5A_Str= baterias.getFOTOS_A5();
        foto6A_Str= baterias.getFOTOS_A6();
        foto1D_Str= baterias.getFOTOS_D1();
        foto2D_Str= baterias.getFOTOS_D2();
        foto3D_Str= baterias.getFOTOS_D3();
        foto4D_Str= baterias.getFOTOS_D4();
        foto5D_Str= baterias.getFOTOS_D5();
        foto6D_Str= baterias.getFOTOS_D6();
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            ...
            /*    Test item = new Test();
                ...
                compositeDisposable.add(iMyAPI.Test(item).subscribeOn(Schedulers.io())
                        .observeOn(AndroidSchedulers.mainThread())
                        .subscribe(new Consumer<Test>() {
                            @Override
                            public void accept(Test lista) throws Exception {
                                //lista.get(0).getItem_Number();
                                if(lista.getRespuesta()=="OK"){
...
*/
                baterias.setFOTOS_A1(foto1A_Str);
                baterias.setFOTOS_A2(foto2A_Str);
                baterias.setFOTOS_A3(foto3A_Str);
                baterias.setFOTOS_A4(foto4A_Str);
                baterias.setFOTOS_A5(foto5A_Str);
                baterias.setFOTOS_A6(foto6A_Str);

                baterias.setFOTOS_D1(foto1D_Str);
                baterias.setFOTOS_D2(foto2D_Str);
                baterias.setFOTOS_D3(foto3D_Str);
                baterias.setFOTOS_D4(foto4D_Str);
                baterias.setFOTOS_D5(foto5D_Str);
                baterias.setFOTOS_D6(foto6D_Str);
    ...
    public void enviarFoto(Test item ){
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
            ...
            paint.setTextAlign(Paint.Align.LEFT);
            paint.setColor(Color.parseColor("#33FF66"));
            canvas.drawText(ltd,15,imageBitmap.getHeight() - (int)(imageBitmap.getHeight() *.18),paint);
            canvas.drawText(fch,15, imageBitmap.getHeight() - (int)(imageBitmap.getHeight()*.10),paint);
