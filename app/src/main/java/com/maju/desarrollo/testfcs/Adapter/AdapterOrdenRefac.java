...
public class AdapterOrden extends BaseAdapter {
    ...
    TextView Cliente ,direccion,fecha,sr,task,item,serie,taskdesc;
    ImageView imagen;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        taskdesc=(TextView) vista.findViewById(R.id.adaptertaskdesc);  //DARIO YA
        ...
        taskdesc.setText(listaOrden.get(position).getTask_Desc()); //DARIO YA
