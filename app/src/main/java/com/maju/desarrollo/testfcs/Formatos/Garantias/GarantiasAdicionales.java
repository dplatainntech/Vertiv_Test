 ...
 */
public class GarantiasAdicionales extends Fragment {
    OperacionesDB D_B;
    String id_formato;
    SGarantias Formato;
    InternetandVPN validaciones = new InternetandVPN();

    public GarantiasAdicionales() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_garantias_adicionales, container, false);
