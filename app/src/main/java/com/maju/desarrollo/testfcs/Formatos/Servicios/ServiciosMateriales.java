 ...
 */
public class ServiciosMateriales extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View v = inflater.inflate(R.layout.fragment_servicios_materiales, container, false);
        ...
        */
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Formato.getNoID6(nid6.getText().toString());
                Formato.setfecha6(fecha6.getText().toString());               
                 */
