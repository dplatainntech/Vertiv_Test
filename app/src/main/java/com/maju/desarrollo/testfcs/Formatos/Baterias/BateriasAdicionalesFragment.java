 ...
 */
public class BateriasAdicionalesFragment extends Fragment {
  ...
  public BateriasAdicionalesFragment() {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    View v = inflater.inflate(R.layout.fragment_baterias_adicionales, container, false);
    ...
    nombre1.setText(baterias.getADICI_NOMBRE1());// = (EditText)v.findViewById(R.id.nombre1);
    correo1.setText(baterias.getADICI_CORREO1());// = (EditText)v.findViewById(R.id.correo1);
    nombre2.setText(baterias.getADICI_NOMBRE2());// = (EditText)v.findViewById(R.id.nombre2);
    correo2.setText(baterias.getADICI_CORREO2());// = (EditText)v.findViewById(R.id.correo2);
    nombre3.setText(baterias.getADICI_NOMBRE3());// = (EditText)v.findViewById(R.id.nombre3);
    correo3.setText(baterias.getADICI_CORREO3());// = (EditText)v.findViewById(R.id.correo3);
    nombre4.setText(baterias.getADICI_NOMBRE4());// = (EditText)v.findViewById(R.id.nombre4);
    correo4.setText(baterias.getADICI_CORREO4());// = (EditText)v.findViewById(R.id.correo4);
    nombre5.setText(baterias.getADICI_NOMBRE5());// = (EditText)v.findViewById(R.id.nombre5);
    correo5.setText(baterias.getADICI_CORREO5());// = (EditText)v.findViewById(R.id.correo5);
    ...
    guardar.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        if(nombre1.getText().toString().isEmpty()&&
          ...
          baterias.setADICI_NOMBRE5(" ");// = (EditText)v.findViewById(R.id.nombre1);
          baterias.setADICI_CORREO5(" ");// = (EditText)v.findViewById(R.id.correo1);

        }else {
          baterias.setADICI_NOMBRE1(nombre1.getText().toString());// = (EditText)v.findViewById(R.id.nombre1);
          baterias.setADICI_CORREO1(correo1.getText().toString());// = (EditText)v.findViewById(R.id.correo1);
          baterias.setADICI_NOMBRE2(nombre2.getText().toString());// = (EditText)v.findViewById(R.id.nombre2);
          baterias.setADICI_CORREO2(correo2.getText().toString());// = (EditText)v.findViewById(R.id.correo2);
          baterias.setADICI_NOMBRE3(nombre3.getText().toString());// = (EditText)v.findViewById(R.id.nombre3);
          baterias.setADICI_CORREO3(correo3.getText().toString());// = (EditText)v.findViewById(R.id.correo3);
          baterias.setADICI_NOMBRE4(nombre4.getText().toString());// = (EditText)v.findViewById(R.id.nombre4);
          baterias.setADICI_CORREO4(correo4.getText().toString());// = (EditText)v.findViewById(R.id.correo4);
          baterias.setADICI_NOMBRE5(nombre5.getText().toString());// = (EditText)v.findViewById(R.id.nombre5);
          baterias.setADICI_CORREO5(correo5.getText().toString());// = (EditText)v.findViewById(R.id.correo5);
        }
