...
public class Garantiasfirmas extends Fragment {
    OperacionesDB D_B;
    String id_formato;
    SGarantias Formato;
    InternetandVPN validaciones = new InternetandVPN();

    public Garantiasfirmas() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_garantiasfirmas, container, false);
...
*/
       final EditText nombreFirma1 = (EditText)v.findViewById(R.id.nombreFirma1);
        ...
        nombreFirma1.setText(Formato.getFIRMA1());
        nombreFirma2.setText(Formato.getFIRMA2());
        nombreFirma3.setText(Formato.getFIRMA13());
        ...
        try{ if(Formato.getIMAGENFIRMA1().length()>10){ F1.setImageResource(R.drawable.btn_firma_verde); } }catch (Exception e){}
        try{ if(Formato.getIMAGENFIRMA2().length()>10){ F2.setImageResource(R.drawable.btn_firma_verde); } }catch (Exception e){}
        try{ if(Formato.getIMAGENFIRMA3().length()>10){ F3.setImageResource(R.drawable.btn_firma_verde); } }catch (Exception e){}
        ...
        F1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                GarantiasLienzo myfargment = new GarantiasLienzo();
