 ...
 */
public class ThermFirmasFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_therm_firmas, container, false);
        ...
        nombreFirma3.setText(Formato.getNomnbreFirmaClienteFinal());
        ...
        F1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Formato.setNomnbreFirmaClienteFinal(nombreFirma3.getText().toString());

                D_B.guardarThrtmal(Formato);

                ThermalLienzo myfargment = new ThermalLienzo();
