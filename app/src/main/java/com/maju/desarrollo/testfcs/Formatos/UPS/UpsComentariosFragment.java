 ...
 */
public class UpsComentariosFragment extends Fragment {
    OperacionesDB D_B;
    String id_Formato;
    UPS item;

    public UpsComentariosFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_ups_comentarios, container, false);
        ((MainActivity) getActivity()).ocultarCabecera();
        D_B = OperacionesDB.obtenerInstancia(getContext());
        id_Formato= getArguments().getString("key_idFormato");
        item = D_B.obtenerUPS(id_Formato);
