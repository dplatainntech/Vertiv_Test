 ...
 */
public class BateriasLienzo extends Fragment {
    OperacionesDB D_B;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_baterias_lienzo, container, false);
        ...
        si.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (customCanvas.comprovarCanvas()==true) {
                    ...
                    if(firma.equals("Firma1")) { baterias.setFIRMA_IMG1(imagenString); }
                    if(firma.equals("Firma2")) { baterias.setFIRMA_IMG2(imagenString); }
                    if(firma.equals("Firma3")) { baterias.setFIRMA_IMG3(imagenString); }
