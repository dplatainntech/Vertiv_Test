 ...
 */
public class PDUMenu extends Fragment {
    OperacionesDB D_B;
    String id_formato;
    IMyAPI iMyAPI;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_pdumenu, container, false);
        ...
        if(id_formato.equals("NUEVO")){
            id_formato = D_B.newPDU();  // = nuevaPreOrden()
            D_B.nuevoRegistroFormato(id_formato,"7"); //crear registrode formato. PDU
        ...
        M1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PDUGenerales myfargment = new PDUGenerales();
        ...
        M2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PDUParametros myfargment = new PDUParametros();
                myfargment.setArguments(args);
                FragmentManager fragmentManager = (getActivity()).getSupportFragmentManager();
                fragmentManager.beginTransaction().replace(R.id.main_fragment_placeholder, myfargment).addToBackStack(null).commit();
            }
        ...
        M3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PDUComentarios myfargment = new PDUComentarios();
                myfargment.setArguments(args);
                FragmentManager fragmentManager = (getActivity()).getSupportFragmentManager();
                fragmentManager.beginTransaction().replace(R.id.main_fragment_placeholder, myfargment).addToBackStack(null).commit();
            }
        ...
        M4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PDUMateriales myfargment = new PDUMateriales();
                myfargment.setArguments(args);
                FragmentManager fragmentManager = (getActivity()).getSupportFragmentManager();
                fragmentManager.beginTransaction().replace(R.id.main_fragment_placeholder, myfargment).addToBackStack(null).commit();
        ...
        M5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PDUFotos myfargment = new PDUFotos();
                myfargment.setArguments(args);
                FragmentManager fragmentManager = (getActivity()).getSupportFragmentManager();
                fragmentManager.beginTransaction().replace(R.id.main_fragment_placeholder, myfargment).addToBackStack(null).commit();
            }
        ...
        M6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PDUFirmas myfargment = new PDUFirmas();
                myfargment.setArguments(args);
                FragmentManager fragmentManager = (getActivity()).getSupportFragmentManager();
                fragmentManager.beginTransaction().replace(R.id.main_fragment_placeholder, myfargment).addToBackStack(null).commit();
            }
        ...
        M7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PDUAdicionales myfargment = new PDUAdicionales();
                myfargment.setArguments(args);
                FragmentManager fragmentManager = (getActivity()).getSupportFragmentManager();
                fragmentManager.beginTransaction().replace(R.id.main_fragment_placeholder, myfargment).addToBackStack(null).commit();
            }
    ...
    public void verAcencesModulos(){
        ...
        //region Modulo 2
        int M2_I = 39;
        try{if(Formato.getRevisionEstadoTransformador().equals("true")
                ...
                || Formato.getRevisionBotonesPanel().equals("true")){M2_I =M2_I - 1;}}catch (Exception e){}

        try{if(!Formato.getVoltajeEAB().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getVoltajeEBC().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getVoltajeECA().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getCorrienteEA().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getCorrienteEB().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getCorrienteEC().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getTemperatura().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getRotacion().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getTaps().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getVoltajeSAB().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getVoltajeSBC().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getVoltajeSCA().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getVoltajeSAN().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getVoltajeSBN().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getVoltajeSCN().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getCorrienteSAB().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getCorrienteSBC().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getCorrienteSCA().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getCorrienteSAN().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getCorrienteSBN().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getCorrienteSCN().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getVTHDA().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getVTHDB().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getVTHDC().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getITHDA().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getITHDB().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getITHDC().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getKFACTORA().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getKFACTORB().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getKFACTORC().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getPEAKRMSA().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getPEAKRMSB().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getPEAKRMSC().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getKVA().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getKW().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getFP().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getPorcentajeCarga().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}
        try{if(!Formato.getKWHR().isEmpty()){M2_I =M2_I - 1;}}catch (Exception e){}

        if(M2_I == 0){im2.setImageResource(R.drawable.lectura2verde);
            completo = completo-1;
        }
        else if(M2_I < 39){im2.setImageResource(R.drawable.lectura2nar);
        }
