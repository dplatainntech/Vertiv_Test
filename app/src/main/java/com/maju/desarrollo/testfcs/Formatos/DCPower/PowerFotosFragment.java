 ...
 */
public class PowerFotosFragment extends Fragment {
    OperacionesDB D_B;
    String id_formato;
    DCPower2 dcPower;
    Bitmap imageBitmap;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_power_fotos, container, false);
        ...
        try{ if(dcPower.getFOTOS_ANTES1().length()>10){foto1_A_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(dcPower.getFOTOS_ANTES2().length()>10){foto2_A_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(dcPower.getFOTOS_ANTES3().length()>10){foto3_A_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(dcPower.getFOTOS_ANTES4().length()>10){foto4_A_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(dcPower.getFOTOS_ANTES5().length()>10){foto5_A_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(dcPower.getFOTOS_ANTES6().length()>10){foto6_A_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}

        try{ if(dcPower.getFOTOS_DESPUES1().length()>10){foto1_D_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(dcPower.getFOTOS_DESPUES2().length()>10){foto2_D_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(dcPower.getFOTOS_DESPUES3().length()>10){foto3_D_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(dcPower.getFOTOS_DESPUES4().length()>10){foto4_D_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(dcPower.getFOTOS_DESPUES5().length()>10){foto5_D_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}
        try{ if(dcPower.getFOTOS_DESPUES6().length()>10){foto6_D_icon.setImageResource(R.drawable.fotoverde);} }catch (Exception e){}

        foto1A_Str= dcPower.getFOTOS_ANTES1();
        foto2A_Str= dcPower.getFOTOS_ANTES2();
        foto3A_Str= dcPower.getFOTOS_ANTES3();
        foto4A_Str= dcPower.getFOTOS_ANTES4();
        foto5A_Str= dcPower.getFOTOS_ANTES5();
        foto6A_Str= dcPower.getFOTOS_ANTES6();
        foto1D_Str= dcPower.getFOTOS_DESPUES1();
        foto2D_Str= dcPower.getFOTOS_DESPUES2();
        foto3D_Str= dcPower.getFOTOS_DESPUES3();
        foto4D_Str= dcPower.getFOTOS_DESPUES4();
        foto5D_Str= dcPower.getFOTOS_DESPUES5();
        foto6D_Str= dcPower.getFOTOS_DESPUES6();
        ...
        guardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dcPower.setFOTOS_ANTES1(foto1A_Str);
                dcPower.setFOTOS_ANTES2(foto2A_Str);
                dcPower.setFOTOS_ANTES3(foto3A_Str);
                dcPower.setFOTOS_ANTES4(foto4A_Str);
                dcPower.setFOTOS_ANTES5(foto5A_Str);
                dcPower.setFOTOS_ANTES6(foto6A_Str);

                dcPower.setFOTOS_DESPUES1(foto1D_Str);
                dcPower.setFOTOS_DESPUES2(foto2D_Str);
                dcPower.setFOTOS_DESPUES3(foto3D_Str);
                dcPower.setFOTOS_DESPUES4(foto4D_Str);
                dcPower.setFOTOS_DESPUES5(foto5D_Str);
                dcPower.setFOTOS_DESPUES6(foto6D_Str);
...
/**
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
          ...
          //  Toast.makeText(getContext(),"Foto en Base64", Toast.LENGTH_SHORT);
